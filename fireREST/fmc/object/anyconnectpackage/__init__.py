...
class AnyconnectPackage(Resource):
    ...
    **Operation IDs:**
    ...
    - `getAllAnyConnectPackageModel` (GET (list))
    - `getAnyConnectPackageModel` (GET)
    - `createAnyConnectPackageModel` (CREATE)
    - `updateAnyConnectPackageModel` (UPDATE)
    - `deleteAnyConnectPackageModel` (DELETE)
